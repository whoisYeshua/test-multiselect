...
export declare const isValueEmpty: <Item extends SelectableControlItem, IsMulti extends boolean = false, UseFullItem extends boolean = false>(value?: SelectValue<Item, IsMulti, UseFullItem>) => boolean;
