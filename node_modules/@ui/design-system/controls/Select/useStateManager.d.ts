...
export interface SelectableControlItem {
    ...
    isCreatable?: boolean;
    /**
     * Дополнительная опция в выпадающем списке
     */
    description?: string;
    /**
     * Вспомогательный маркер в айтеме, отвечающий за привязку к `field` в `CombinedSelect`.
     */
    fieldName?: string;
}
