...
export declare type ButtonVariant = 'primary' | 'primary-alt' | 'secondary' | 'tertiary' | 'transparent' | 'brand-secondary' | 'error' | 'error-alt' | 'warning' | 'warning-alt' | 'success' | 'success-alt' | 'on-color' | 'custom' | 'control-icon' | 'page-bg' | 'white';
export declare type OnButtonClick = (event: React.MouseEvent<HTMLButtonElement>) => void | Promise<void>;
