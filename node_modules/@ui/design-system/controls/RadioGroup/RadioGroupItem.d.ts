...
declare const RadioGroupItem: {
    <Item extends SelectableControlItem>({ backgroundColor, colorScheme, id, name, item, checked, disabled, tooltip, errors, renderCustomLabel, onClick, isTableMode, onChange, onTooltipClick, }: RadioGroupItemProps<Item>): JSX.Element;
    defaultProps: {
        backgroundColor: string;
    };
};
