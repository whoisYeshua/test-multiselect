...
export interface PanelProps {
    ...
    /**
     * Кастомизируемый отступ от заголовка, применяется только в открытом состоянии панели на всех разрешениях экрана.
     */
     ...
     * `full-invisible` - отсутствие видимой границы и сохранение внутренних отступов панели как для стиля `full`.
     * `none` - границы отсутствуют, отступы аналогичны `horizontal`.
     ...
     */
    borderStyle?: 'full' | 'horizontal' | 'full-invisible' | 'none';
    /**
     * Для панели с границами `full`.
    ...
    /**
     * Стиль фона панели.
     * Не работает в режиме границ `none`.
     */
    bgStyle?: 'white' | 'grey' | 'transparent';
    /**
     ...
     * Убирает нижний бордер.
     * Работает только при `isStepPanel` и `borderStyle full`
     */
    isLastStep?: boolean;
    /**
