...
export declare type TypographyVariant = 'primary' | 'primary-fixed' | 'secondary' | 'tertiary' | 'on-color' | 'on-color-fixed' | 'brand-primary' | 'brand-secondary' | 'warning' | 'warning-contrast' | 'error' | 'error-contrast' | 'success' | 'success-contrast' | 'disabled';
